    ...
    <div ref={ref} className="z-50">
      <div className="mt-1 relative z-30">
        <button
          ...
          } relative w-full border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm z-20`}
