...
export default function HotelsTable({ data, isLoading, handleUpdate }) {
  const columns = [
    ...
    {name: "ARABIC NAME", uid: "ar_name", sortable: true},
    { name: "ADDRESS", uid: "address" },
    {name: "ARABIC ADDRESS", uid: "ar_address"},
    { name: "CITY", uid: "city" },
    { name: "ARABIC CITY", uid: "ar_city" },
    { name: "STATE", uid: "state", sortable: true },
    {name: "ARABIC STATE", uid: "ar_state"},
    ...
    { name: "ARABIC DESCRIPTION", uid: "ar_description" },
