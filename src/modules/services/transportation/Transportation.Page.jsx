    ...
    <div className="m-5 mt-1 pr-10 p-5 rounded-lg bg-white w-full">
      ...
      <div className="my-5">
        <div className="flex justify-between mb-3">
          ...
          <Button
            onClick={() => navigate(`/user/transportations/${id}`)}
        ...
        <div>
          ...
          <div className="mt-2">
            <h1 className="font-semibold">{t("About_Transport")}</h1>
            <p>{data?.description}</p>

            <br />

            <h1 className="font-semibold">{t("Transport_Details")}</h1>
            <table className="table-auto w-full mt-2">
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border px-4 py-2">
                    {data?.transportation?.departureAddress}
                  </td>
                </tr>
                <tr>
                  <td className="border px-4 py-2 font-semibold">
                  ...
                  <td className="border px-4 py-2">
                    {data?.transportation?.arrivalAddress}
                  </td>
                </tr>
                <tr>
                  <td className="border px-4 py-2 font-semibold">
                  ...
                  <td className="border px-4 py-2">
                    {new Date(
                      data?.transportation?.departureTime,
                    ).toLocaleString()}
                  </td>
                </tr>
              </tbody>
