    ...
    <div className="m-5 mt-1 pr-10 p-5 rounded-lg bg-white w-full">
      ...
      <div className="my-5">
        <div className="flex justify-between mb-3">
          ...
          <Button
            onClick={() => navigate(`/user/standard-packages/${id}`)}
        ...
        <div>
          ...
          <div className="mt-2">
            <h1 className="font-semibold">{t("About_Package")}</h1>
            <p>{data?.description}</p>

            <br />

            <h1 className="font-semibold">{t("Package_Details")}</h1>
...
export default StandardPackagesPage;
